...
public class ModelAntlerHorns extends ModelRenderer {
	...
	public ModelAntlerHorns(IModelMPM base) {
		super(base.getBiped());
		ModelRenderer right_base_horn = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer right_horn1 = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer right_horn2 = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer things1 = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer things2 = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer left_base_horn = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer left_horn1 = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer left_horn2 = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer things8 = new ModelRenderer(base.getBiped(), 58, 20);
		...
		ModelRenderer things4 = new ModelRenderer(base.getBiped(), 58, 20);
