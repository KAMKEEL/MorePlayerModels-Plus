...
public class ModelBullHorns extends ModelRenderer {
	...
	public ModelBullHorns(IModelMPM base) {
		super(base.getBiped());
		ModelRenderer Left1 = new ModelRenderer(base.getBiped(), 36, 16);
		Left1.mirror = true;
		Left1.addBox(0F, 0F, 0F, 2, 2, 2);
		Left1.setRotationPoint(4F, -8F, -2F);
		addChild(Left1);
		
		ModelRenderer Right1 = new ModelRenderer(base.getBiped(), 36, 16);
		Right1.addBox(-3F, 0F, 0F, 2, 2, 2);
		Right1.setRotationPoint(-3F, -8F, -2F);
		addChild(Right1);
		
		ModelRenderer Left2 = new ModelRenderer(base.getBiped(), 12, 16);
		Left2.mirror = true;
		...
		ModelRenderer Right2 = new ModelRenderer(base.getBiped(), 12, 16);
		Right2.addBox(-2F, 0F, 0F, 2, 2, 2);
		Right2.setRotationPoint(-5F, -8F, -2F);
		setRotation(Right2, 0.0371786F, -0.3346075F, 0.2602503F);
		addChild(Right2);
		
		ModelRenderer Left3 = new ModelRenderer(base.getBiped(), 13, 17);
		Left3.mirror = true;
		...
		ModelRenderer Right3 = new ModelRenderer(base.getBiped(), 13, 17);
