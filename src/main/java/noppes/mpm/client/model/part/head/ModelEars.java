...
public class ModelEars extends ModelPartInterface {
	...
	public ModelEars(IModelMPM par1ModelBase) {
		super(par1ModelBase);
		
		ears = new ModelRenderer(base.getBiped());
		this.addChild(ears);

		Model2DRenderer right = new Model2DRenderer(base.getBiped(), 56, 0, 8, 4, 64, 32);
		right.setRotationPoint(-7.44f, -7.3f, -0.0f);
		right.setScale(0.234f, 0.234f);
		right.setThickness(1.16f);
		ears.addChild(right);

		Model2DRenderer left = new Model2DRenderer(base.getBiped(), 56, 0, 8, 4, 64, 32);
		...
		Model2DRenderer right2 = new Model2DRenderer(base.getBiped(), 56, 4, 8, 4, 64, 32);
		right2.setRotationPoint(-7.44f, -7.3f, 1.14f);
		right2.setScale(0.234f, 0.234f);
		right2.setThickness(1.16f);
		ears.addChild(right2);

		Model2DRenderer left2 = new Model2DRenderer(base.getBiped(), 56, 4, 8, 4, 64, 32);
		...
		bunny = new ModelRenderer(base.getBiped());
		this.addChild(bunny);
		
		ModelRenderer earleft = new ModelRenderer(base.getBiped(), 56, 0);
		earleft.mirror = true;
		earleft.addBox(-1.466667F, -4F, 0F, 3, 7, 1);
		earleft.setRotationPoint(2.533333F, -11F, 0F);
		bunny.addChild(earleft);

		ModelRenderer earright = new ModelRenderer(base.getBiped(), 56, 0);
