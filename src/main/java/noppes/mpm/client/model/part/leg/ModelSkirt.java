...
public class ModelSkirt extends ModelPartInterface {
	...
	public ModelSkirt(IModelMPM base) {
		super(base);
		float pi = (float) (Math.PI / 5);

		Shape1 = new ModelPlaneRenderer(base.getBiped(), 58, 18);
		Shape1.addSidePlane(0, 0, 0, 9, 2);
		
		ModelPlaneRenderer part1 = new ModelPlaneRenderer(base.getBiped(), 58, 18);
	...
	public void setRotationAngles(float par1, float par2, float par3,
		...
		setRotation(Shape1, 0.3F, -0.2f, -0.2F);
    	Shape1.rotateAngleX += base.getBiped().bipedLeftArm.rotateAngleX * 0.04f;
    	Shape1.rotateAngleZ += base.getBiped().bipedLeftArm.rotateAngleX * 0.06f;
