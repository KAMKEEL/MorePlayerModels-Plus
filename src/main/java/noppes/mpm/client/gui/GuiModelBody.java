...
public class GuiModelBody extends GuiModelInterface{
	...
	private final String[] arrParticles = new String[]{"gui.no","gui.player","1","2", "particle.rainbow", "3", "4", "5", "6", "7"};
    ...
    protected void actionPerformed(GuiButton btn) {
    	...
    	if(button.id == 12){
    		this.mc.displayGuiScreen(new GuiModelColor(this, playerdata.getPartData("particles")));
    	}
    	if(button.id == 13){
    		this.mc.displayGuiScreen(new GuiModelColor(this, playerdata.getPartData("fin")));
    	}
    	if(button.id == 14){
    		this.mc.displayGuiScreen(new GuiModelColor(this, playerdata.getPartData("skirt")));
    	}
    }
